...
void AttachBranch(std::string branchName, double_t *data) {

}

void AttachBranch(std::string branchName, Int_t *data) {

}

void AttachBranch(std::string branchName, TTree *tree_in, Int_t *data) {
	// check the existence of the branch, and attach the data buffer to the branch
...
void gemNoiseSignalLevel(TString fname = "/home/newdriver/PRex/PRex_Data/GEMRootFile/prexRHRS_21289_00_test.root",std::string HRS="RHRS"){
	...
	/*
	std::string noisePattern_x("RGEM.rgems.x%d.strip.adcnoise");
	std::string noisePattern_y("RGEM.rgems.y%d.strip.adcnoise");
	*/
}
